  ...
  <div class="headphone-container">
    ...
    <nav class="nav-bar">
      <div class="nav-content">
        ...
        <div class="nav-links">
          <a href="#" @click.prevent="router.push('/shopping')">Home</a>
          ...
          <a href="#" class="active" @click.prevent="router.push('/headphone')">HeadPhone</a>
        </div>
...
export default {
  ...
  setup() {
    ...
    const fetchProducts = async () => {
      try {
        loading.value = true
        const response = await product.getProductsByCategory('headphone', {
          params: {
        ...
        console.error('Failed to load headphone products. Please try again later', error)
      } finally {
        loading.value = false
      }
    }
